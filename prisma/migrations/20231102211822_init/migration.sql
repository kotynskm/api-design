...
-- AddForeignKey
ALTER TABLE "UpdatePoint" ADD CONSTRAINT "UpdatePoint_udpateId_fkey" FOREIGN KEY ("udpateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
